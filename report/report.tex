...
\gtododhruv{Can you summarise the sections in the article, i.e. something like, not sure if this is a bit plain atm, but maybe Jim or Dhruv will have a better idea?: The structure of our report is as follows: we discuss related work in \ref{section:related_work}, methodologies in \ref{section:methods}, experimental set up in \ref{section:experimental-setup}, results and discussion in \ref{section:results-discussion}, and conclusion in \ref{conclusion}}
