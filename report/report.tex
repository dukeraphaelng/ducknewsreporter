...
\tododhruv{I changed the comment from the tutor to remove "Model 1". Could you fix this graph so the headings are BERT, BERT+Non-Latent, BERT + Non-Latent + Similarity. See my ML results table.}
